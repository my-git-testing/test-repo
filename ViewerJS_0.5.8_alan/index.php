...
*/
      ...
      <style media="screen" type="text/css">
       ...
       .titlebar > span,.toolbarLabel,input,button,select {
           font: message-box;
       }
       #titlebar {
           position: absolute;
       ...
       html[dir='rtl'] #toolbarRight,html[dir='rtl'] #titlebarRight {
           margin-left: -1px;
       }
       html[dir='ltr'] #toolbarLeft,html[dir='rtl'] #toolbarRight,html[dir='rtl'] #titlebarRight {
           position: absolute;
           top: 0;
           left: 0;
       }
       html[dir='rtl'] #toolbarLeft,html[dir='ltr'] #toolbarRight,html[dir='ltr'] #titlebarRight {
           position: absolute;
           top: 0;
           right: 0;
       }
       html[dir='ltr'] #toolbarLeft > *,html[dir='ltr'] #toolbarMiddle > *,html[dir='ltr'] #toolbarRight > *,html[dir='ltr'] #titlebarRight > * {
           float: left;
       }
       html[dir='rtl'] #toolbarLeft > *,html[dir='rtl'] #toolbarMiddle > *,html[dir='rtl'] #toolbarRight > *,html[dir='rtl'] #titlebarRight > * {
           float: right;
       }
       ...
       html[dir='rtl'] .toolbarButton,html[dir='rtl'] .dropdownToolbarButton {
           margin: 3px 0 4px 2px;
       }
       ...
       .toolbarButton:hover:active,.dropdownToolbarButton:hover:active {
       ...
       .splitToolbarButton > .toolbarButton:hover,.splitToolbarButton > .toolbarButton:focus,.dropdownToolbarButton:hover,.toolbarButton.textButton:hover,.toolbarButton.textButton:focus {
           background-color: hsla(0,0%,0%,.2);
       ...
       .toolbarButton.toggled:hover:active,.splitToolbarButton > .toolbarButton:hover:active {
      ...
      <style media="only screen and (max-device-width: 800px) and (max-device-height: 800px)" type="text/css" viewerTouch="1">
      ...
      <div id = "viewer">
         ...
         <div id="toolbarContainer">
            ...
            <div id="toolbar">
               ...
               <div id="toolbarRight">
               <!--
                  <button id="download" class="toolbarButton download" onclick="downloadPDF()" style="display:none"></button>
                -->
               </div>
            </div>
         </div>
